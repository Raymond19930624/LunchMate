...
"[project]/src/ai/flows/data:88a72d [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/ai/flows/data:4c780d [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$88a72d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:88a72d [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$4c780d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:4c780d [app-client] (ecmascript) <text/javascript>");
...
function UserOrderCard({ userOrder, onPaymentUpdate, onOrderUpdate }) {
    ...
    const handlePaymentStatusChange = (username, isPaid)=>{
        ...
        startTransition(async ()=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$88a72d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["markUserOrderAsPaid"])({
                    dailyOrderId,
                    username,
                    isPaid
                });
    ...
    const handleSaveChanges = ()=>{
        ...
        startTransition(async ()=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$4c780d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserOrder"])({
                    dailyOrderId,
...
function OrderDetailClient({ initialOrderDetails }) {
    ...
    const ordersByUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrderDetailClient.useMemo[ordersByUser]": ()=>{
            ...
            const groupedByUser = orderDetails.reduce({
                "OrderDetailClient.useMemo[ordersByUser].groupedByUser": (acc, item)=>{
            ...
            }["OrderDetailClient.useMemo[ordersByUser].groupedByUser"], {});
            // Then, for each user, aggregate their items
            return Object.entries(groupedByUser).map({
                "OrderDetailClient.useMemo[ordersByUser]": ([username, items])=>{
                    const aggregatedItemsMap = items.reduce({
                        "OrderDetailClient.useMemo[ordersByUser].aggregatedItemsMap": (acc, item)=>{
                    ...
                    }["OrderDetailClient.useMemo[ordersByUser].aggregatedItemsMap"], new Map());
                    const aggregatedItems = Array.from(aggregatedItemsMap.values());
                    const total = aggregatedItems.reduce({
                        "OrderDetailClient.useMemo[ordersByUser].total": (sum, item)=>sum + item.quantity * item.price
                    }["OrderDetailClient.useMemo[ordersByUser].total"], 0);
                    return {
                        username,
    ...
    const ordersByItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OrderDetailClient.useMemo[ordersByItem]": ()=>{
            ...
            const groupedByItem = orderDetails.reduce({
                "OrderDetailClient.useMemo[ordersByItem].groupedByItem": (acc, item)=>{
            ...
            }["OrderDetailClient.useMemo[ordersByItem].groupedByItem"], new Map());
            // Convert the map to the final array structure
            return Array.from(groupedByItem.values()).map({
                "OrderDetailClient.useMemo[ordersByItem]": (group)=>({
                        itemName: group.itemName,
                        options: group.options,
                        totalQuantity: group.totalQuantity,
                        price: group.price,
                        users: Array.from(group.usersMap.entries()).map({
                            "OrderDetailClient.useMemo[ordersByItem]": ([name, quantity])=>({
                                    name,
                                    quantity
                                })
                        }["OrderDetailClient.useMemo[ordersByItem]"])
                    })
            }["OrderDetailClient.useMemo[ordersByItem]"]).sort({
...
"[project]/src/ai/flows/data:71116c [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$71116c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:71116c [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/button.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function OrderDetailPage() {
    ...
    const fetchOrderDetails = async ()=>{
        ...
        setError(null);
        try {
            const { orderDetails: fetchedDetails, dailyOrder: fetchedDailyOrder } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$71116c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getOrderDetailsByDailyOrderId"])(dailyOrderId);
...
//# sourceMappingURL=src_079c6c33._.js.map