...
// const allVendors: { id: string, name: string, description: string }[] = [
// ];
const initialMenus = {};
function MenuAdminPage({ params }) {
    ...
    const handleAddItem = (e)=>{
        ...
        toast({
            title: "品項已新增 (模擬)",
            description: "此為模擬操作，尚未寫入 Google Sheet。"
        });
    };
    const handleDeleteItem = (itemId, itemName)=>{
        ...
        toast({
            title: "品項已刪除 (模擬)",
            description: `${itemName} 已從菜單移除。此為模擬操作，尚未寫入 Google Sheet。`
        });
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__166271ab._.js.map